...
def train_model(args, model, training_dataloader, validation_dataloader, device, scaler):
    ...
    for epoch in range(args.epochs):
        ...
        validation_loss, confusion_matrix, classification_report, bias_report, stereotype_report = evaluate_model(model, validation_dataloader, val=True)
        
        print(type(bias_report))
        ...
        print('Bias Report:')
        print(bias_report["macro avg"]["f1-score"])
        print('Stereotype Report:')
        print(stereotype_report["macro avg"]["f1-score"])
        print('---------------------------------')
